...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgQAAxkBAAEIrdpkQ7H6Vbn86fUmcsTXnSQxtQKbbAACQQwAAli4SVN7M7KmxMKX3y8E")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"⚡[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/DelightSeekers) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
👨‍🚀 **ᴄʜᴀɴɴᴇʟ:** {channel}
🖇️ **ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ:** [ᴠɪsɪᴛ ᴄʜᴀɴɴᴇʟ]({channellink})
⚡ **ᴊᴏɪɴ:** [🍁CʜᴀᴛʜᴜB🍁](https://t.me/DelightSeekers)
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/DelightSeekers"
                        ),
                    ],
                ]
            )
